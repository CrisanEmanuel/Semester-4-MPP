...
import agentie.persistence.Hibernate.ExcursieHibernateRepo;
...
public class StartRpcServer {
    ...
    public static void main(String[] args) {
        ...
        //IRepoExcursie excursieHibernateRepo = new ExcursieHibernateRepo();
        ...
        // IService agentieServerImpl = new ServiceImpl(angajatDBRepo, excursieHibernateRepo, rezervareDBRepo);
