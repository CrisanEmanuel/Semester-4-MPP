...
//    @Override
//    public Optional<Angajat> findAngajatByUsername(String username) throws AgentieException {
//        Request req = new Request.Builder().type(RequestType.CAUTA_ANGAJAT_DUPA_USERNAME).data(username).build();
//        sendRequest(req);
//        Response response = readResponse();
//        if (response.type() == ResponseType.ERROR) {
//            String err = response.data().toString();
//            throw new AgentieException(err);
//        }
//        return Optional.ofNullable((Angajat) response.data());
//    }
